...
### Plot
yn = -0.1
p_ks_spec = PlotCFEnrichmentHorizontal(res_ks_spec, scoreType=sprintf('%s KS/CellSpecific', toupper(database)), pval=pval_ks_spec, y_nudge=yn)
p_ks_multi = PlotCFEnrichmentHorizontal(res_ks_multi, scoreType=sprintf('%s KS/CellConsensus', toupper(database)), pval=pval_ks_multi, y_nudge=yn)
p_xsum_spec = PlotCFEnrichmentHorizontal(res_xsum_spec, scoreType=sprintf('%s XSum/CellSpecific', toupper(database)), pval=pval_xsum_spec, y_nudge=yn)
p_xsum_multi = PlotCFEnrichmentHorizontal(res_xsum_multi, scoreType=sprintf('%s XSum/CellConsensus', toupper(database)), pval=pval_xsum_multi, y_nudge=yn)
